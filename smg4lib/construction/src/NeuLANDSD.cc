...
NeuLANDSD::NeuLANDSD(G4String name) : G4VSensitiveDetector(name)
{;}
//____________________________________________________________________
NeuLANDSD::~NeuLANDSD()
{;}
//____________________________________________________________________
void NeuLANDSD::Initialize(G4HCofThisEvent* /*HCTE*/)
{;}
//____________________________________________________________________
G4bool NeuLANDSD::ProcessHits(G4Step* aStep, G4TouchableHistory* /*ROhist*/)
{
  SimDataManager *sman = SimDataManager::GetSimDataManager();
  TClonesArray *SimDataArray = sman->FindSimDataArray("NeuLANDSimData");
...
#ifdef DEBUG
    if(SimDataArray){
      G4cout << "NeuLAND_array size="<<SimDataArray->GetEntries()
	     << " data :"  << *data << G4endl;
    }
#endif
  }
...
//____________________________________________________________________
void NeuLANDSD::EndOfEvent(G4HCofThisEvent* /*HCTE*/)
{;}
//____________________________________________________________________
