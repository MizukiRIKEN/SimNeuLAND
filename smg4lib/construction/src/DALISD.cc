...
DALISD::DALISD(G4String name) : G4VSensitiveDetector(name)
{;}
//____________________________________________________________________
DALISD::~DALISD()
{;}
//____________________________________________________________________
void DALISD::Initialize(G4HCofThisEvent* /*HCTE*/)
{;}
//____________________________________________________________________
G4bool DALISD::ProcessHits(G4Step* aStep, G4TouchableHistory* /*ROhist*/)
{
  SimDataManager *sman = SimDataManager::GetSimDataManager();
  TClonesArray *SimDataArray = sman->FindSimDataArray("DALISimData");
...
#ifdef DEBUG
    if(SimDataArray){
      G4cout << "DALI_array size="<<SimDataArray->GetEntries()
	     << " data :"  << *data << G4endl;
    }
#endif
  }
...
//____________________________________________________________________
void DALISD::EndOfEvent(G4HCofThisEvent* /*HCTE*/)
{;}
//____________________________________________________________________
